...
Method key: **Phonetic** = in-house deterministic baseline (`phonetic.py`) · **Aksharamukha** = external library (`aksharamukha_method.py`) · **uroman** = external universal romanizer (`uroman_method.py`)
